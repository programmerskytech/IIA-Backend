-- =====================================================
-- CLEANUP AND SEED - EXACT 11 FORMS ONLY (Safe Mode Compatible)
...
-- This version works with MySQL Workbench safe mode enabled
-- =====================================================

-- Temporarily disable safe mode for this session
...
('EmployeeRegistration', 'Employee Registration', 'Employee registration and management', 'Admin', true, 7, 'SYSTEM'),
...
-- 8. EMPLOYEE REGISTRATION: 3 fields
INSERT INTO designator_master (form_id, designator_name, designator_display_name, data_type, is_active, display_order, created_by)
